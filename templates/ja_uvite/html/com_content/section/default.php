...
<tr>
	...
	<?php if ($this->params->get('show_description_image') && $this->section->image) : ?>
		<img src="images/stories/<?php echo $this->escape($this->section->image);?>" align="<?php echo $this->escape($this->section->image_position);?>" hspace="6" alt="<?php echo $this->escape($this->section->image);?>" />
	<?php endif; ?>
