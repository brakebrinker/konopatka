...
<tr>
	...
	<td>
		<input style="width: 99%" type="text" id="created_by_alias" name="created_by_alias" size="50" maxlength="100" value="<?php echo $this->escape($this->article->created_by_alias); ?>" class="inputbox" />
	</td>
</tr>
<tr>
	<td class="key">
...
<input type="hidden" name="version" value="<?php echo $this->escape($this->article->version); ?>" />
<input type="hidden" name="created_by" value="<?php echo $this->escape($this->article->created_by); ?>" />
