...
<tr>
	...
	<?php if ($this->category->image) : ?>
		<img src="images/stories/<?php echo $this->escape($this->category->image);?>" align="<?php echo $this->escape($this->category->image_position);?>" hspace="6" alt="<?php echo $this->escape($this->this->category->image);?>" />
	<?php endif; ?>
